...
def main() -> None:
    ...
    while stask:
        ...
        for p in moto:
            nxt = cur + p
            if len(nxt) > 10 or (val := int(nxt)) > limit:
                continue
            s.add(val)
...
"""
10
[DEBUG] [1, 2, 4, 8, 16, 32, 64, 128, 256, 512]
512
"""
"""
10
[DEBUG] [248, 256, 264, 281, 282, 284, 288, 321, 322, 324, 328, 411, 412, 414, 416, 418, 421, 422, 424, 428]
[DEBUG] 34397
21
"""
